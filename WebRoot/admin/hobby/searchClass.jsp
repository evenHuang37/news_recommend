...
<center>
<form method="get" action="searchClass.jsp" name="divPage" >
   ...
   if(c <MaxPage){
     if(c == PageNo){
       if(c %PageSize == 0){
        ...
        out.print("<a href=searchClass.jsp?PageNo="+c+">"+c+"</a> ,");
     }
   }else{
     if(PageNo == MaxPage){
      out.print(c);
...
if(PageNo < MaxPage){ //如果当前页不是最后一页，则显示下一页链接
    NextPage = PageNo + 1;
    //out.print("<a href=searchClass.jsp?PageNo="+NextPage+">下一页</a>");
}
...
if(PageNo < MaxPage){
   ...
   //out.print(":");
    //out.print("<a href=searchClass.jsp?PageNo="+MaxPage+">最后一页</a>");
  }
  out.print("</font>");
%>
</div>
